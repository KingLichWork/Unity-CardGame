...
{
    [HideInInspector] public event Action<CardInfoScript> ChoseCardAction;
    ...
    private void Awake()
    {
        ChoseCardAction += GameManager.Instance.ChoseCard;
    }
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        {
            ChoseCardAction.Invoke(eventData.pointerCurrentRaycast.gameObject.GetComponent<CardInfoScript>());
        }
    }
